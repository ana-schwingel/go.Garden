...
<html>
    <head>
        ...
        <link href="css/editProfile.css" rel="stylesheet" media="all">
    </head>
                ...
                <div class="row">
                    <div class="col-md-offset-1">
                        ...
                        <div class="col-md-10">
                            ...
                            <a href="editProfName.php?i=<?=$_SESSION['username']?>&c=name"><span class="glyphicon glyphicon-pencil"> Editar</span></a>
                        </div>            
                    </div>
                </div><hr>
                <div class="row">
                    <div class="col-md-offset-1">
                    <div class="col-md-1">Nome de usuário</div>
                    <div class="col-md-10">
                ...
                <div class="row">
                    <div class="col-md-offset-1">
                        ...
                        <div class="col-md-10">
                            ...
                            <a href="editProfEmail.php?i=<?=$_SESSION['username']?>&c=email"><span class="glyphicon glyphicon-pencil"> Editar</span></a>
                    </div>                    
                    </div>
                </div><hr>
                <div class="row">
                    <div class="col-md-offset-1">
                        ...
                        <div class="col-md-10">
                            ...
                            <a href="editProfTel.php?i=<?=$_SESSION['username']?>&c=telephone"><span class="glyphicon glyphicon-pencil"> Editar</span></a>
                        </div>                    
                    </div>
                </div><hr>
                <div class="row">
                    <div class="col-md-offset-1">
                        ...
                        <div class="col-md-10">
                            <p><?php echo $row['uf']?></p>
                            <a href="editProfUf.php?i=<?=$_SESSION['username']?>&c=uf"><span class="glyphicon glyphicon-pencil"> Editar</span></a>
                        </div>
                    </div>
                </div><hr>
                <div class="row">
                    <div class="col-md-offset-1">
                        ...
                        <div class="col-md-10">
                            <a href="editProfKey.php?i=<?=$_SESSION['username']?>&c=password"><span class="glyphicon glyphicon-pencil"> Editar</span></a>
                        </div>
                    </div>
                </div><hr>
            </div>
