...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <h2>Cadastro de hortaliça</h2>
            <form class="form-horizontal" method="post" action="adminVegetableRegister.php">
                <div class="form-row">
                    <div class="form-group">
                        <label for="inputName" class="col-md-1 col-form-label">Nome</label>
                        <div class="col-md-2">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="inputDescription" class="col-md-1 col-form-label">Descrição</label>
                        <div class="col-md-4">
                            <textarea rows="5" id="inputDescription" name="inputDescription"></textarea>
                        </div>
                        <label for="inputVarieties" class="col-md-1 col-form-label">Variedades</label>
                        <div class="col-md-4">
                ...
                <div class="form-row" id="rowBtn">
                    <button class="button btnGG btnGray hvr-trim">Cancelar</button>
