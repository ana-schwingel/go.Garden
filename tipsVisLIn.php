...
<html>
    <head>
        ...
        <link href="css/veg.css" rel="stylesheet" media="all">
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <h2>Acesse o Forum:</h2>
            <div class="row">
				<?php while ($rows = mysqli_fetch_assoc($result_sql_vegetables)){ ?>
					<div class="col-xs-12 col-md-4 vegMain" id="<?=$rows['name']?>">
						<a href="tipsVisMainLIn.php?i=<?=$rows['id']?>"><?=$rows['name']?></a>
					</div>
				<?php } ?>
				
			<!--
                <div class="col-xs-12 col-md-4 vegMain" id="alface">
                    <a href="redirForumAlface.php">Alface</a>
                </div>
                <div class="col-xs-12 col-md-4 vegMain" id="tomate">
                    <a href="redirForumTomate.php">Tomate</a>
                </div>
                <div class="col-xs-12 col-md-4 vegMain" id="cenoura">
                    <a href="redirForumCenoura.php">Cenoura</a>
                </div>
			-->
            </div>
        </div>
