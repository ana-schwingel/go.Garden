...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <form class="form-horizontal" method="post" action="editProfileUf.php">
                <input class="hidden" name="i" id="i" value="<?=$_GET['i']?>">
                <input  type="text "class="hidden" name="cat" id="cat" value="<?=$_GET["c"]?>">
                <div class="form-row">
                    <div class="form-group">
                        <label for="val" class="col-md-2 col-form-label">UF</label>
                        <select class="custom-select col-md-2" name="val" id="val">
