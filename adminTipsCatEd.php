...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <form class="form-horizontal" method="post" action="adminTipsCatEdit.php">
                <input class="hidden" name="id" id="id" value="<?=$_GET['i']?>">
                <div class="form-row">
                    <div class="form-group">
                        <label for="tipText" class="col-md-2 col-form-label">Categoria da dica</label>
                        <div class="col-md-8">
                            <textarea rows="5" id="tCat" name="tCat"></textarea>
                        </div>
                    </div>
                </div>
