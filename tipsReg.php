...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <form class="form-horizontal" method="post" action="tipsRegister.php">
                <input type="hidden" name="userId" id="userId" value="<?=$_SESSION['userId'] ?>">
                <div class="form-row">
                    <div class="form-group">
                        <label for="inputVegetable" class="col-md-2 col-form-label">Escolha a hortaliça</label>
                        <select class="col-md-2" id="code" name="code">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="tipText" class="col-md-2 col-form-label">Texto</label>
                        <div class="col-md-8">
                            <textarea rows="5" id="tipText" name="tipText"></textarea>
                        </div>
                    </div>
                </div>
