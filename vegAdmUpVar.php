...
<html>
    ...
    <body>
        ...
        <!-- content -->
        <div class="container-fluid">
            <h2>Edição de variedades</h2>
            <form class="form-horizontal" method="post" action="vegAdmUpdateVar.php">
                <div class="form-row">
                    <div class="form-group">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="inputDescription" class="col-md-2 col-form-label">Variedades</label>
                        <div class="col-md-8">
                            <textarea rows="5" id="inputVarieties" name="inputVarieties"></textarea>
                        </div>
                    </div>
                </div>
