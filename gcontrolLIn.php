...
<html>
    <head>
        ...
        <link href="css/goGarden.css" rel="stylesheet" media="all">
    ...
    <body>
        ...
        <!-- content -->
        <div class="container-fluid" id="gControlPresentation">
            <h2>gControl - o que faltava para você cultivar suas hortaliças.</h2>
            <div class="row">
                <div class="col-xs-12 col-md-6">
                    <img src="imgs/homeHorta/arduino.jpg">
                </div>
                <div class="col-xs-12 col-md-6">
                    <img id="print" src="imgs/new/gControl.png">
                </div>
            </div>
            <div class="row" id="txtRow">
                <p>
					O Arduino é uma placa eletrônica programável. É um dispositivo que ao mesmo tempo é barato, funcional e fácil de programar, sendo dessa forma acessível a estudantes e projetistas amadores.
					<br />No sistema goGarden, baseado em IoT (Internet of Things – Internet das Coisas, em português) foi utilizada a placa Arduino em conjunto com sensores de umidade do ar, umidade do solo, temperatura e luminosidade.
					<br />Os sensores são uma parte essencial do empreendimento. Esse conjunto de dispositivos (Arduino e sensores) são responsáveis por coletar os dados da hortaliça e enviar para o site.
				</p>
            </div>
        </div>
