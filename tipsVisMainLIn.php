<?php
    ...
    $sql_utips = "SELECT usertips.text as text, usertips.id as id, profiles.username as username
                    FROM usertips
                    INNER JOIN profiles
                    ON usertips.profiles_id = profiles.id
                    WHERE usertips.vegetables_id = '$i'";
    $result_utips = mysqli_query($mysqli, $sql_utips);
    $row = mysqli_fetch_assoc($result_utips);
    }
?>
<!DOCTYPE html>
<html>
            ...
            <div class="row">
                <div class="row">
                    <div class="col-md-offset-10">
                        <a href="tipsReg.php" class="button btnGG btnPurple hvr-trim">Publicar</a>
                    </div>
                </div>                
            </div>
            <h2>Visualização de dicas</h2>
            <?php while ($rows = mysqli_fetch_assoc($result_utips)){ ?>
            <div class="row">
                <div class="col-md-1">
