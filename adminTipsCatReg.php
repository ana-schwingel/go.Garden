...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <h2>Cadastro de categoria de dica</h2>
            <form class="form-horizontal" method="post" action="adminTipsCatRegister.php">
                <div class="form-row">
                    <input type="text" name="tipCategory" id="tipCategory">
                </div>
