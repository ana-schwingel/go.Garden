...
<html>
    ...
    <body>
        ...
        <!-- content -->
        <div class="container-fluid">
            <h2>Edição de nome de hortaliça</h2>
            <form class="form-horizontal" method="post" action="vegAdmUpdateName.php">
                <div class="form-row">
                    <div class="form-group">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="inputDescription" class="col-md-2 col-form-label">Nome</label>
                        <div class="col-md-8">
