...
<html>
    <head>
        ...
        <link href="css/navigationPost.css" rel="stylesheet" media="all">
    ...
    <body>
        ...
        <div class="container-fluid">
            <h2></h2>
            <h2>Pronto para publicar? ''Selecione uma imagem, adicione uma legenda e compartilhe!</h2>
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="navigationPosts.php">
                <fieldset>
                    <input type="hidden" name="i" id="i" value="<?=$_SESSION['userId'] ?>">
                    <div class="form-group">
                        <label for="inputImage" class="col-lg-2 control-label">Escolha uma imagem</label>
                        <div class="col-lg-4">
                            <input type="file" name="flimage" id="flimagein">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputLegend" class="col-lg-2 control-label">Adicione uma legenda</label>
                        <div class="col-lg-4">
                            <textarea rows="3" class="col-lg-12" id="inputLegend" name="inputLegend"></textarea>
                        </div>
                    </div>
