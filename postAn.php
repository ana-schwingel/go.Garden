...
<html>
    ...
    <body>
        ...
        <!-- content -->
        <div class="container-fluid">            
            <h2>Resposta de post</h2>
            <form class="form-horizontal" method="post" action="postAnswer.php">
                <input type="hidden" name="postId" id="postId" value="<?=$_GET['i']?>">
                <input type="hidden" name="userId" id="userId" value="<?=$_SESSION['userId'] ?>">
                <div class="form-row">
                    <div class="form-group">
                        <label for="inputAnsw" class="col-md-2 col-form-label">Responda</label>
                        <div class="col-md-8">
                            <textarea rows="5" id="inputAnsw" name="inputAnsw"></textarea>
                        </div>
                    </div>
                </div>
                <div class="form-row" id="rowBtn">
                    <button class="button btnGG btnGray hvr-trim" type="reset" type="reset">Cancelar</button>
