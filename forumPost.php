...
<html>
    <head>
        ...
        <link href="css/forumPost.css" rel="stylesheet" media="all">
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <?php } ?>
                ...
                <form class="form-horizontal" method="post" action="forumPostReg.php">
                    <fieldset>
                        <legend>Têm uma dúvida? Descreva seu problema!</legend>
                        <input type="hidden" name="userId" id="userId" value="<?=$_SESSION['userId'] ?>">
                        <div class="form-group">
                            <label for="inputVegetable" class="col-lg-2 control-label">Hortaliça</label> <div class="col-lg-2">
                                <select id="inputVegetable" name="inputVegetable" class="form-control">
                        ...
                        <div class="form-group">
                            <label for="inputText" class="col-lg-2 control-label">Texto</label>
                            <div class="col-lg-8">
                                <textarea rows="5" id="inputText" name="inputText"></textarea>
                            </div>
                        </div>
                        <button class="button btnGG btnGrey hvr-trim" type="reset">Cancelar</button>
                        <button class="button btnGG btnPurple hvr-trim">Publicar</button>
                    </fieldset>
                </form>
        </div>
