    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <?php } ?>
                ...
                <form class="form-horizontal" method="post" action="evidencesRegister.php">
                    <fieldset>
                        <legend>Já plantou? Compartilhe sua experiência!</legend>
                    ...
                    -->
                        <div class="form-group">
                            <label for="textEvidence" class="col-lg-2 control-label">Texto</label>
                            <div class="col-lg-8">
                                <textarea rows="5" id="textEvidence" name="textEvidence"></textarea>
                            </div>
                        </div>
