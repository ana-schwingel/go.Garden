...
<html>
    ...
    <body>
        ...
        <!-- content -->
        <div class="container-fluid">
            <h2>Edição de valor de controle de hortaliça</h2>
            <form class="form-horizontal" method="post" action="adminVegControlEdit.php">
                <input class="hidden" name="i" id="i" value="<?=$_GET['i']?>">
                <input  type="text "class="hidden" name="cat" id="cat" value="<?=$_GET["c"]?>">
                <div class="form-row">
                    <div class="form-group">
                        <label for="val" class="col-md-2 col-form-label">Novo valor</label>
                        <div class="col-md-8">
