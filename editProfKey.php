...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <form class="form-horizontal" method="post" action="editProfileKey.php">
                <input class="hidden" name="i" id="i" value="<?=$_GET['i']?>">
                <input  type="text "class="hidden" name="cat" id="cat" value="<?=$_GET["c"]?>">
                <div class="form-row">
                    <div class="form-group">
                        <label for="val" class="col-md-2 col-form-label">Senha atual</label>
                        <div class="col-md-8">
                            <input type="password" name="val1" id="val1">
                        </div>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label for="val" class="col-md-2 col-form-label">Nova senha</label>
                        <div class="col-md-8">
                            <input type="password" name="val2" id="val2">
                        </div>
                    </div>
                </div>
