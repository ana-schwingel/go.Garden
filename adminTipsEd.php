...
<html>
    ...
    <body>
        ...
        <!-- content -->
        <div class="container-fluid">
            <h2>Edição de dicas</h2>
            <form class="form-horizontal" method="post" action="adminTipsEdit.php">
                <input class="hidden" name="id" id="id" value="<?=$_GET['i']?>">
                <div class="form-row">
                    <div class="form-group">
                        <label for="tipText" class="col-md-2 col-form-label">Descreva a dica</label>
                        <div class="col-md-8">
